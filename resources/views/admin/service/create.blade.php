...
@section('form')
    ...
    {{ html()->file('document')->multiple()->attribute('data-allowed-file-extensions', 'pdf doc docx xls xlsx ppt pptx')->accept('.pdf, .doc, .docx, .xls, .xlsx, .ppt, .pptx')->class('dropify-document') }}
